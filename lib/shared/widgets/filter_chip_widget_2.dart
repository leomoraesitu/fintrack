...
/// FilterChipWidget2: Versão alternativa do Filter Chip, com parâmetros de tamanho customizáveis.
//@preview
class FilterChipWidget2 extends StatelessWidget {
  final IconData icon;
  final String label;
  final bool selected;
...
Widget filterChipWidget2Preview() => const FilterChipWidget2(
